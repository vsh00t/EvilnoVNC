...
sudo docker run -d --rm -p $PORT:5980 -v "${PWD}/Downloads":"/home/user/Downloads" -e RESOLUTION=$RESOLUTION -e WEBPAGE=$WEBPAGE --name evilnovnc_$PORT vsh00t/evilnovnc > /dev/null 2>&1
printf "\n\e[1;33m[>] EvilnoVNC Server is running.." ; sleep 3
printf "\n\e[1;34m[+] URL: http://localhost:"$PORT ; sleep 3
